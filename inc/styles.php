...
function PointJupiter_hex2rgba($color, $opacity = false) {
...
//Dynamic styles
function PointJupiter_custom_styles($custom) {
	...
	$menu_rgba 	= PointJupiter_hex2rgba($menu_bg, 0.9);
	...
	wp_add_inline_style( 'PointJupiter-style', $custom );	
}
add_action( 'wp_enqueue_scripts', 'PointJupiter_custom_styles' );