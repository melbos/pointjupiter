...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'PointJupiter' ); ?></a>

	<header id="masthead" class="site-header <?php echo PointJupiter_has_header(); ?>" role="banner">
		<div class="container">
			<div class="site-branding col-md-4 col-sm-6 col-xs-12">
				<?php PointJupiter_branding(); ?>
			</div>
	...
	<?php $PointJupiter_has_header = PointJupiter_has_header(); ?>
	<?php if ( $PointJupiter_has_header == 'has-header' ) : ?>
	<div class="header-image">
		<?php PointJupiter_header_text(); ?>
	...
	<?php elseif ( $PointJupiter_has_header == 'has-shortcode' ) : ?>
	<div class="shortcode-area">
		<?php $shortcode = get_theme_mod('PointJupiter_shortcode'); ?>
		<?php echo do_shortcode(wp_kses_post($shortcode)); ?>
	</div>
	<?php elseif ( $PointJupiter_has_header == 'has-video' ) : ?>
		<?php the_custom_header_markup(); ?>
	<?php elseif ( $PointJupiter_has_header == 'has-single' ) : ?>
		<?php $single_toggle = get_post_meta( $post->ID, '_PointJupiter_single_header_shortcode', true ); ?>
	...
	<?php do_action('PointJupiter_before_content'); ?>
